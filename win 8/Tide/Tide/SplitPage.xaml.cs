...
namespace Tide
{
    ...
    /// </summary>
    public sealed partial class SplitPage : Tide.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            TideData tideData = e.Parameter as TideData;
            if (tideData != null)
            {
                this.DefaultViewModel["Tide"] = tideData;
                this.DefaultViewModel["Items"] = tideData.Items;
        ...
        void ItemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            TideDateItem tideDateItem = list.SelectedItem as TideDateItem;

            if (tideDateItem != null)
            {
                this.DefaultViewModel["LeastDateItems"] = tideDateItem.Items;
